...
public class Server {
    ...
    public static void sendData(File[] files, String[] args)
    {
...
/*if(i == files.length)
                        {
                            ...
                            PrintWriter pw = new PrintWriter(new OutputStreamWriter(cg.getOutputStream())); // INICIAMOS FLUJO
                                                                                                // DE DATOS
                            //pw.println(files.length); // ENVIAMOS LA LONGITUD DE ARCHIVOS SELECCIONADOS
                            //pw.flush();
                            ...
                            pw.close(); // CERRAMOS FLUJO DE DATOS
                            for(String k : nameProducts) System.out.println("k);
                            break;
                        }*/